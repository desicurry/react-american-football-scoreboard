    ...
    <div className="container">
      ...
      <section className="buttons">
        <div className="homeButtons">
          ...
          <button className='homeButtons_twoPoints' onClick={() => setHomeScore(homeScore + 2)}>Home Two Points</button>
        </div>
        <div className="awayButtons">
          ...
          <button className='awayButtons_twoPoints' onClick={() => setAwayScore(awayScore + 2)}>Home Two Points</button>
        </div>
      </section>
    </div>
  );
